...
const redirect_uri = 'https://russellkirkpatrick.github.io/spotify-api-pokedex-controller/';
...
function getApiReq(){
  fetch('https://api.spotify.com/v1/me/top/tracks?time_range=medium_term&limit=50&offset=0', {
    method: 'GET', headers: {
